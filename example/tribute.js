  ...
  var TributeSearch = /*#__PURE__*/function () {
    ...
    _createClass(TributeSearch, [{
      ...
      value: function match(pattern, string, opts) {
        ...
        var patternCache = this.traverse(compareString, pattern, 0, 0, [], opts.matchInputInStartsWithMode);
      ...
      value: function showMenuFor(element, scrollTo) {
        ...
        var processValues = function processValues(values) {
          ...
          var items = _this2.search.filter(_this2.current.mentionText, values, {
            ...
            matchInputInStartsWithMode: _this2.current.collection.searchOpts.matchInputInStartsWithMode || false,
